			...
			<div class="col-xs-12 col-sm-6 col-md-8" >
				...
				<tbody>
					<?php 
						...
						if($_POST['promotype_name'] == ""){
							$data = $crud->fetch("promo_type","","grouppromo_id='".$_GET['id']."' limit $posisi,$batas");			
						}else{
							$data = $crud->fetch("promo_type","","grouppromo_id='".$_GET['id']."' and promotype_name like '%".$_POST['promotype_name']."%' limit $posisi,$batas");	
						}
