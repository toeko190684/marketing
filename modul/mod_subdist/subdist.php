			...
			<div class="col-xs-12 col-sm-6 col-md-8" >
				...
				<tbody>
					<?php 
						...
						if($_POST['subdist_name'] == ""){
							$data = $crud->fetch("subdist","","area_id='".$_GET['id']."' limit $posisi,$batas");			
						}else{
							$data = $crud->fetch("subdist","","area_id='".$_GET['id']."' and subdist_name like '%".$_POST['subdist_name']."%' limit $posisi,$batas");	
						}
